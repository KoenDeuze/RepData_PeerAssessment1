...
library(lattice)
xyplot(averages_week_weekend$steps ~ averages_week_weekend$interval | factor(averages_week_weekend$week_weekend), data=activity, pch=20, main="weekend vs weekdays", xlab="interval",  ylab="steps",layout=c(2,1),type=c("l"))
```
